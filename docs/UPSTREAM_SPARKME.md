...
> Upstream README from [SALT-NLP/SparkMe](https://github.com/SALT-NLP/SparkMe), kept for reference. It describes the original WorkBank interview system, not the Arabic study. For this fork, start at the [root README](../README.md).
